...
\begin{figure}[!ht]
    ...
    \begin{tikzpicture}
        ...
        \draw (6,11.5) ellipse (0.35cm and 0.98cm);
        \draw (7,11.5) ellipse (0.35cm and 0.98cm);
...
\emph{Универзум типови} се могу сматрати као типови кога настањују други типови. Универзум тип $\mathcal{U}$ омогућава да се исказ $A~\type$ запише формално као $A : \mathcal{U}$. Поред тога, омогућава да се фамилија типова $B$ над типом $A$ дефинише као функција $B : A \to \mathcal{U}$. 
