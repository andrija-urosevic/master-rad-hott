...
Постоји пуно разлога за изучавање ХоТТ и заснивање математике кроз интерактивне доказиваче теорема, али један од главних је објављен у раду \emph{The Origins and Motivations of Univalent Foundations} \cite{vlad14}:
...
Теорију типова је оригинално представио Бертранд Расел \cite{rus08}, решавајући парадок у заснивању математике тог времена. Након њега Алонзо Черч, развија \emph{просто типизирани ламбда рачун} (ПРЛР) (енгл. \emph{Simply Typed Lambda Calculus}) \cite{crc40, crc41}. Теорију типова даље развија Пер Мартин-Луф коју данас знамо као МЛТТ, или \emph{зависна/интуиционистичка/конструктивистичка теорија типова} \cite{pml98, pml75, pml82, pml84}.
